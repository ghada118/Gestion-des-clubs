 ...
 */
final class Version20241212182230 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement ADD type_evenement_id INT NOT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement DROP type_evenement_id, CHANGE image image VARCHAR(255) NOT NULL');
    }
}
