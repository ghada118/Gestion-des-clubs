 ...
 */
final class Version20241123143002 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE formation (idf INT AUTO_INCREMENT NOT NULL, typeformation_id INT NOT NULL, date_pub DATETIME NOT NULL, titre VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, datelimite DATETIME NOT NULL, INDEX IDX_404021BF47A44D41 (typeformation_id), PRIMARY KEY(idf)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
